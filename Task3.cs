...
{
    /*
        You arrive at the airport only to realize that you grabbed your Banbur-ID instead of your passport. 
        While these documents are extremely similar, Banbur-IDs aren't issued by a country and therefore aren't actually valid 
    ...
    */
    public class Task3
    {
        ...
        public Task3()
        {
            _puzzleInput = File.ReadAllText("passports.txt");
        }
